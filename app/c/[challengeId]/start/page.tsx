...
export default function StartChallengePage({ params: { challengeId } }: { params: { challengeId: string } }) {
    ...
    return (
                ...
                <div className="flex flex-col h-full w-full py-10 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                    <div className="mx-auto">
                        <Image alt="challenge photo" src="https://i.scdn.co/image/ab67616d00001e02ff9ca10b55ce82ae553c8228" width="300" height="300" className="w-64 h-64 mx-auto object-contain aspect-auto" />
                    </div>
                    <div className="p-4">
